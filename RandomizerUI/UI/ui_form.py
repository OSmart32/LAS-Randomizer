...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.seashellsCheck.setCheckable(True)
...
#if QT_CONFIG(whatsthis)
        self.seashellsCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"This controls whether seashells from Trees, Grass, Rocks, and Pots can be progress items<br></br><u>If this is not checked,</u> they will not be randomized", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.enemySizesCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Randomizes the size of the enemies. Required kills are left vanilla", None))
#endif // QT_CONFIG(whatsthis)
