...
def mamashaChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event15')
...
def ciaociaoChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event21')
...
def saleChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event31')
...
def kikiChanges(flowchart, placements, settings, item_defs):
    ...
    get_event = event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, None, 'Event102')
...
def tarinChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event130', 'Event29')
...
def chefChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event16', None) # Event4
...
def papahlChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event32', 'Event62')
...
def christineChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event15', 'Event22')
...
def mrWriteChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event48', 'Event46')
...
def grandmaYahooChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event54', 'Event33')
...
def fishermanChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event28', 'Event42')
...
def mermaidChanges(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[item]['item-key'], item_index, 'Event73', 'Event55')
