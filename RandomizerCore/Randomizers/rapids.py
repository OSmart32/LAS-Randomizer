...
def makePrizesStack(flowchart, placements, item_defs):
    ...
    event_tools.createGetItemEvent(flowchart, item_defs[placements['rapids-race-45']]['item-key'], item_index, 'Event42', 'Event88')
    ...
    get35 = event_tools.createGetItemEvent(flowchart, item_defs[placements['rapids-race-35']]['item-key'], item_index, None, 'Event86')
    ...
    get30 = event_tools.createGetItemEvent(flowchart, item_defs[placements['rapids-race-30']]['item-key'], item_index, None, 'Event85')
