...
def changeHeartPiece(flowchart, item_key, item_index, model_path, model_name, room, room_data):
    ...
    act = [a for a in room_data.actors if a.type == 0xB0][0]
    ...
    act.parameters[1] = bytes('ObjSinkingSword.bfres' if item_key == 'SwordLv1' else model_path, 'utf-8')
    act.parameters[2] = bytes('SinkingSword' if item_key == 'SwordLv1' else model_name, 'utf-8')
