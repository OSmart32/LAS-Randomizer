...
from RandomizerCore.randomizer_data import FLOWCHARTS
from RandomizerCore.ASM import assemble
from RandomizerCore.Paths.randomizer_paths import IS_RUNNING_FROM_SOURCE

from RandomizerCore.Tools import (bntx_tools, event_tools, flow_tool, leb, lvb, oead_tools)
...
class ModsProcess(QtCore.QThread):
    ...
    def clothesFairyChanges(self):
        # will need to read from the output instead because of the new flowchart system
